...
namespace MVCConcesionaria.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(ConcesionariaDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonaId,PersonaDNI,Nombre,Apellido")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonaId,PersonaDNI,Nombre,Apellido")] Persona persona)
        {
